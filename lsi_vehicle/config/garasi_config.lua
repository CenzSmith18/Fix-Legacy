...
Config.PolicePounds = {
	Los_Santos = {
		Marker = vector3(593.86, 3.34, 70.63),
		Spawner = vector3(588.91, -2.78, 69.11),
		Heading = 87.03
	}
}
-- End of Police
...
Config.AircraftGarages = {
	Garasi_HeliPheton = {
		Marker = vector3(-2598.75, 1694.08, 140.87),
		Spawner = vector3(-2584.54, 1701.76, 140.36),
		Deleter = vector3(-2584.54, 1701.76, 140.36),
		Heading = 148.4
	}
}
...
Config.AircraftPounds = {
	Los_Santos_Airport = {
		Marker = vector3(-707.9, -1448.8, 4),
		Spawner = vector3(-701, -1447.2, 5),
		Heading = 47.59
	}
}
-- End of Aircrafts
...
--[[Config.CarGarages = {
	['Los_Santos'] = {
		Marker = vector3(-310.4, -951.92, 30.08),
		Spawner = vector3(-314.84, -944.49, 30.6),
		Deleter = vector3(-311.47, -934.0, 30.08),
		Heading = 157.84,
		npc = {
			text = 'Akses Garasi',
			heading = 68.38
	...
	['Sandy_Shores'] = {
		Marker = vector3(1737.34, 3710.68, 33.13),
	...
	['Paleto_Bay'] = {
		Marker = vector3(105.59, 6604.18, 30.94),
	...
	['Garasi_Kenzo'] = {
		Marker = vector3(-123.82, 1007.14, 234.73),
		Spawner = vector3(-116.53, 999.56, 233.66),
		Deleter = vector3(-129.22, 1003.32, 234.63),
		Heading = 315.01
	},

	['Garasi_Nelson'] = {
		Marker = vector3(-2613.52, 1678.21, 140.87),
		Spawner = vector3(-2603.98, 1677.97, 140.87),
		Deleter = vector3(-2610.21, 1685.39, 140.87),
		Heading = 222.88
	},

	['Garasi_Jaki'] = {
		Marker = vector3(-1863.49, 189.42, 83.29),
		Spawner = vector3(-1878.67, 185.54, 83.81),
		Deleter = vector3(-1870.2, 190.18, 83.29),
		Heading = 129.9 
	},
	['Garasi_Satan'] = {
		Marker = vector3(-856.18, -49.4, 38.13),
		Spawner = vector3(-873.91, -52.8, 38.21),
		Deleter = vector3(-866.33, -53.64, 37.63),
		Heading = 281.65 
	},
	['Garasi_Donasi'] = {
		Marker = vector3(156.83, -3017.92, 6.04),
		Spawner = vector3(164.85, -3011.34, 5.91),
		Deleter = vector3(165.9, -2993.96, 5.89),
		Heading = 129.9 
	}
...
Config.CarGarages = {
	Los_Santos = {
		Marker = vector3(-518.4, -601.81, 29.44),
		Spawner = vector3(-509.78, -602.64, 29.77),
		Deleter = vector3(-509.59, -622.78, 28.78),
		Heading = 179.96,
		npc = {
			text = 'Akses Garasi',
			heading = 274.67
...
Config.CarPounds = {
	['Los_Santos_IMP'] = {
		Marker = vector3(408.11, -1625.5, 28.29),
	...
	['Sandy_Shores_IMP'] = {
		Marker = vector3(1650.69, 3796.7, 33.84),
