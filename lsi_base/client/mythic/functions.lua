        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if IsControlJustPressed(1, 323) and mythic_action.canCancel then
            ...
            SendAlert({type = 'error', text = 'Already Doing An Action'})
        end
    else
        SendAlert({type = 'error', text = 'Cannot Perform An Action While Dead'})
    end
end
